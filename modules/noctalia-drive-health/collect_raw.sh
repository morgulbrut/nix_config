...
#
# Vendored from noctalia's gustav0ar/drive-health community plugin
# (materialized/community/drive-health/scripts/collect_raw.sh, plugin version
# 1.2.6) into this repo so the root-privileged systemd service below always
# runs a copy we've reviewed, instead of whatever the auto-updating community
# plugin currently ships. Re-sync by hand if the upstream script changes.
